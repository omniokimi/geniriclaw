...
from geniriclaw.config import AgentConfig, update_config_file_async
from geniriclaw.infra.file_watcher import FileWatcher
from geniriclaw.infra.restart import EXIT_RESTART
from geniriclaw.multiagent.health import AgentHealth
from geniriclaw.multiagent.models import SubAgentConfig, merge_sub_agent_config
from geniriclaw.multiagent.registry import AgentRegistry
from geniriclaw.multiagent.stack import AgentStack
from geniriclaw.workspace.paths import resolve_paths

if TYPE_CHECKING:
    from geniriclaw.multiagent.bus import InterAgentBus
    from geniriclaw.multiagent.internal_api import InternalAgentAPI
    from geniriclaw.multiagent.shared_knowledge import SharedKnowledgeSync
...
class AgentSupervisor:
    ...
    def __init__(self, main_config: AgentConfig) -> None:
        ...
        self._main_paths = resolve_paths(geniriclaw_home=main_config.geniriclaw_home)
        self._agents_path = self._main_paths.geniriclaw_home / "agents.json"
    ...
    async def start(self) -> int:
        ...
        if self._main_config.tasks.enabled:
            from geniriclaw.tasks.hub import TaskHub
            from geniriclaw.tasks.registry import TaskRegistry
        ...
        if self._main_config.docker.enabled and self._main_config.docker.extras:
            from geniriclaw.infra.docker_extras import calculate_build_timeout, resolve_extras
        ...
        shared_path = self._main_paths.geniriclaw_home / "SHAREDMEMORY.md"
    ...
    async def _start_sub_agent(self, sub_cfg: SubAgentConfig) -> None:
        ...
        agent_home = self._main_paths.geniriclaw_home / "agents" / name
