"""Platform-dispatching service management for geniriclaw.
...
if sys.platform == "win32":
    from geniriclaw.infra import service_windows as _backend
elif sys.platform == "darwin":
    from geniriclaw.infra import service_macos as _backend
else:
    from geniriclaw.infra import service_linux as _backend
...
def install_service(console: Console | None = None) -> bool:
    """Install and start the geniriclaw background service. Returns True on success."""
    return _backend.install_service(console)


def uninstall_service(console: Console | None = None) -> bool:
    """Stop and remove the geniriclaw background service."""
