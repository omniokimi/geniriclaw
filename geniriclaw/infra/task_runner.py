...
async def run_oneshot_task(
    ...
    *,
    ...
    """
    from geniriclaw.cron.execution import build_cmd, execute_one_shot
...
async def execute_in_task_folder(  # noqa: PLR0913
    ...
    *,
    ...
    """
    from geniriclaw.cron.dependency_queue import get_dependency_queue
    from geniriclaw.cron.execution import enrich_instruction
