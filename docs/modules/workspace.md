...
Workspace/home-directory management for `~/.geniriclaw`.

## Files

- `paths.py`: immutable `GeniriclawPaths` + `resolve_paths()`
...
- `geniriclaw_home`: `~/.geniriclaw` (default)
- `workspace`: `~/.geniriclaw/workspace`
- `config_path`: `~/.geniriclaw/config/config.json`
- `sessions_path`: `~/.geniriclaw/sessions.json`
- `named_sessions_path`: `~/.geniriclaw/named_sessions.json`
- `env_file`: `~/.geniriclaw/.env`
- `tasks_registry_path`: `~/.geniriclaw/tasks.json`
- `chat_activity_path`: `~/.geniriclaw/chat_activity.json`
- `startup_state_path`: `~/.geniriclaw/startup_state.json`
- `inflight_turns_path`: `~/.geniriclaw/inflight_turns.json`
- `cron_jobs_path`: `~/.geniriclaw/cron_jobs.json`
- `webhooks_path`: `~/.geniriclaw/webhooks.json`
- `logs_dir`: `~/.geniriclaw/logs`
- `cron_tasks_dir`: `~/.geniriclaw/workspace/cron_tasks`
- `tasks_dir`: `~/.geniriclaw/workspace/tasks`
- `api_files_dir`: `~/.geniriclaw/workspace/api_files`
- `skills_dir`: `~/.geniriclaw/workspace/skills`
...
- sub-agent homes do not create `logs/` by default; all agents write to the main home log file `~/.geniriclaw/logs/agent.log`.
...
- Docker mode notice (`/geniriclaw` mount)
...
- `~/.geniriclaw/workspace/skills`
- `~/.claude/skills`
- `~/.codex/skills`
- `~/.gemini/skills`

Default mode uses symlinks/junctions. Docker mode uses managed directory copies (`.geniriclaw_managed`) so paths resolve inside container namespace.
