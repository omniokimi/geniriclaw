...
from geniriclaw._home_defaults.workspace.tools._tool_shared import (
    available_ids,
    find_by_id,
...
GENIRICLAW_HOME = Path(os.environ.get("GENIRICLAW_HOME", "~/.geniriclaw")).expanduser()
HOOKS_PATH = GENIRICLAW_HOME / "webhooks.json"
CONFIG_PATH = GENIRICLAW_HOME / "config" / "config.json"
CRON_TASKS_DIR = GENIRICLAW_HOME / "workspace" / "cron_tasks"
