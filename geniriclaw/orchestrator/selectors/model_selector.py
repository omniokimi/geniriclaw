...
from geniriclaw.config import CLAUDE_MODELS_ORDERED, get_gemini_models, update_config_file_async
from geniriclaw.i18n import t
from geniriclaw.multiagent.registry import update_agent_fields
from geniriclaw.orchestrator.selectors.models import Button, ButtonGrid, SelectorResponse

if TYPE_CHECKING:
    from geniriclaw.cli.codex_cache import CodexModelCache
    from geniriclaw.orchestrator.core import Orchestrator
    from geniriclaw.session import SessionData
...
async def switch_model(
    ...
    *,
    ...
    if not is_topic:
        ...
        if orch.paths.geniriclaw_home.parent.name == "agents":
            agents_path = orch.paths.geniriclaw_home.parent.parent / "agents.json"
