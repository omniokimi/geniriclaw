...
- sub-agents are loaded from `~/.geniriclaw/agents.json`
...
3. if `tasks.enabled=true`: create shared `TaskHub` (`~/.geniriclaw/tasks.json` + `~/.geniriclaw/workspace/tasks/`) and attach it to `InternalAgentAPI`
