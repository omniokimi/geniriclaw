...
@pytest.fixture
def orch_ia(workspace: tuple[GeniriclawPaths, AgentConfig]) -> Orchestrator:
...
class TestInteragentChatId:
    ...
    def test_returns_zero_when_no_users(self, workspace: tuple[GeniriclawPaths, AgentConfig]) -> None:
        paths, config = workspace
