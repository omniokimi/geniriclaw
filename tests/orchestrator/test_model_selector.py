...
from geniriclaw.config import reset_gemini_models, set_gemini_models
from geniriclaw.orchestrator.core import Orchestrator
from geniriclaw.orchestrator.selectors.model_selector import (
...
def _patch_auth(auth_map: dict[str, AuthResult]) -> Any:
    return patch(
        "geniriclaw.orchestrator.selectors.model_selector.check_all_auth",
