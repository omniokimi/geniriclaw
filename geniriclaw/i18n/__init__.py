"""Internationalization module for geniriclaw-bot.

Public API::

    from geniriclaw.i18n import init, t, t_rich, t_cmd, t_plural
...
from geniriclaw.i18n.loader import TranslationStore
