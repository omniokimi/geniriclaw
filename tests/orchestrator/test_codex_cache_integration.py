...
async def test_orchestrator_starts_cache_observer(mock_codex_cache: CodexModelCache) -> None:
    ...
    with (
        patch("geniriclaw.orchestrator.observers.CodexCacheObserver", return_value=mock_observer),
        patch("geniriclaw.orchestrator.lifecycle.resolve_paths"),
        patch("geniriclaw.orchestrator.lifecycle.inject_runtime_environment"),
...
async def test_orchestrator_passes_cache_to_observers(
    ...
    with (
        patch(
            "geniriclaw.orchestrator.observers.CodexCacheObserver", return_value=mock_cache_observer
        ),
        patch("geniriclaw.orchestrator.observers.CronObserver", mock_cron_class),
        patch("geniriclaw.orchestrator.observers.WebhookObserver", mock_webhook_class),
        patch("geniriclaw.orchestrator.lifecycle.resolve_paths"),
        patch("geniriclaw.orchestrator.lifecycle.inject_runtime_environment"),
        patch("geniriclaw.cli.auth.check_all_auth", return_value={}),
    ):
