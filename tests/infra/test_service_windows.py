...
from geniriclaw.infra.service_windows import (
    _TASK_NAME,
    _generate_task_xml,
    _is_access_denied,
    install_service,
...
class TestIsServiceInstalled:
    @patch("geniriclaw.infra.service_windows._run_schtasks")
    def test_installed_when_query_succeeds(self, mock_run: MagicMock) -> None:
        mock_run.return_value = make_completed(0, stdout="TaskName: geniriclaw")
...
class TestIsServiceRunning:
    @patch("geniriclaw.infra.service_windows.is_service_installed", return_value=False)
    def test_not_running_when_not_installed(self, _mock: MagicMock) -> None:
        assert is_service_running() is False

    @patch("geniriclaw.infra.service_windows._run_schtasks")
    @patch("geniriclaw.infra.service_windows.is_service_installed", return_value=True)
    def test_running_when_status_contains_running(
        self, _installed: MagicMock, mock_run: MagicMock
    ) -> None:
        mock_run.return_value = make_completed(0, stdout='"geniriclaw","Running","Interactive"')
    ...
    def test_not_running_when_status_says_ready(
        ...
        mock_run.return_value = make_completed(0, stdout='"geniriclaw","Ready","Interactive"')
        assert is_service_running() is False
...
class TestInstallService:
    @patch("geniriclaw.infra.service_windows._run_schtasks")
    @patch("geniriclaw.infra.service_windows.is_service_installed", return_value=False)
    @patch("geniriclaw.infra.service_windows.is_service_available", return_value=True)
    @patch(
        "geniriclaw.infra.service_windows._find_pythonw",
        return_value=r"C:\Python\pythonw.exe",
    )
    @patch("geniriclaw.infra.service_windows._task_xml_path")
    ...
    @patch("geniriclaw.infra.service_windows.is_service_installed", return_value=False)
    @patch("geniriclaw.infra.service_windows.is_service_available", return_value=True)
    @patch("geniriclaw.infra.service_windows._find_pythonw", return_value=None)
    @patch("geniriclaw.infra.service_windows.find_geniriclaw_binary", return_value="geniriclaw.exe")
    @patch("geniriclaw.infra.service_windows._task_xml_path")
    ...
    @patch("geniriclaw.infra.service_windows.is_service_available", return_value=False)
    ...
    @patch("geniriclaw.infra.service_windows.is_service_available", return_value=True)
    @patch("geniriclaw.infra.service_windows._find_pythonw", return_value=None)
    @patch("geniriclaw.infra.service_windows.find_geniriclaw_binary", return_value=None)
...
class TestStopService:
    @patch("geniriclaw.infra.service_windows._run_schtasks")
    @patch("geniriclaw.infra.service_windows.is_service_running", return_value=True)
    ...
    @patch("geniriclaw.infra.service_windows.is_service_running", return_value=False)
...
class TestPrintServiceLogs:
    ...
    @patch("geniriclaw.infra.service_windows.resolve_paths")
    @patch("geniriclaw.infra.service_windows.is_service_installed", return_value=True)
    def test_shows_logs_from_file(
        ...
        logs_dir.mkdir()
        log_file = logs_dir / "geniriclaw_2026-02-21.log"
