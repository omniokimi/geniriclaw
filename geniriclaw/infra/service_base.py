...
def find_geniriclaw_binary() -> str | None:
    """Find the geniriclaw binary in PATH. Shared across all backends."""
    return shutil.which("geniriclaw")
...
def print_binary_not_found(console: Console) -> None:
    """Print the 'geniriclaw binary not found' error."""
...
def print_install_success(
    ...
    *logs_hint* is the description next to ``geniriclaw service logs``.
    """
    console.print(
        Panel(
