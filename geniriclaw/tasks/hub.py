...
from geniriclaw.tasks.models import TaskEntry, TaskInFlight, TaskResult, TaskSubmit

if TYPE_CHECKING:
    from pathlib import Path

    from geniriclaw.cli.service import CLIService
    from geniriclaw.config import TasksConfig
...
class TaskHub:
    ...
    def set_agent_paths(self, agent_name: str, paths: GeniriclawPaths) -> None:
    ...
    async def _run(
        ...
        *,
        ...
        from geniriclaw.cli.types import AgentRequest
