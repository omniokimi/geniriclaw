...
def _shared_path() -> Path:
    ...
    Priority:
    1. GENIRICLAW_SHARED_MEMORY_PATH env var (set by framework)
    2. GENIRICLAW_HOME / SHAREDMEMORY.md (works for main agent)
    3. Navigate up from sub-agent home: agents/<name>/ -> ../../SHAREDMEMORY.md
    """
    env_path = os.environ.get("GENIRICLAW_SHARED_MEMORY_PATH")
    if env_path:
    ...
    # Sub-agent: home is ~/.geniriclaw/agents/<name>/, shared is at ~/.geniriclaw/SHAREDMEMORY.md
