...
from geniriclaw.config import _GEMINI_ALIASES, CLAUDE_MODELS, get_gemini_models
...
def resolve_cli_config(
    ...
    *,
    ...
    Raises:
        GeniriclawError: If model validation fails
    """
    ...
    return TaskExecutionConfig(
        ...
        working_dir=base_config.geniriclaw_home,
