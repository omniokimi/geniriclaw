...
class TestBuildWelcomeText:
    def test_both_providers_authenticated(self) -> None:
        from geniriclaw.messenger.telegram.welcome import build_welcome_text
        ...
        assert "Welcome to geniriclaw.dev, Alice!" in text
    ...
    def test_user_name_present(self) -> None:
        ...
        assert "Welcome to geniriclaw.dev, Zara!" in text

    def test_user_name_empty(self) -> None:
        from geniriclaw.messenger.telegram.welcome import build_welcome_text

        text = build_welcome_text("", {}, _config())
        assert "Welcome to geniriclaw.dev!" in text
        assert "Welcome to geniriclaw.dev, " not in text
...
class TestBuildAuthBlock:
    def test_both_ok_mentions_both_providers(self) -> None:
        from geniriclaw.messenger.telegram.welcome import _build_auth_block
...
class TestBuildWelcomeKeyboard:
    def test_returns_inline_keyboard_markup(self) -> None:
        ...
        from geniriclaw.messenger.telegram.welcome import build_welcome_keyboard
    ...
    def test_callback_data_matches_welcome_keys(self) -> None:
        from geniriclaw.messenger.telegram.welcome import WELCOME_CALLBACKS, build_welcome_keyboard
    ...
    def test_button_labels_match_expected(self) -> None:
        from geniriclaw.messenger.telegram.welcome import _BUTTON_LABELS, build_welcome_keyboard
...
class TestIsWelcomeCallback:
    ...
    def test_valid_welcome_data(self, data: str) -> None:
        from geniriclaw.messenger.telegram.welcome import is_welcome_callback
...
class TestResolveWelcomeCallback:
    ...
    def test_known_keys_return_prompt(self, key: str, expected_substring: str) -> None:
        from geniriclaw.messenger.telegram.welcome import resolve_welcome_callback
