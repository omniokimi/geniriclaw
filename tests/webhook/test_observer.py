...
from geniriclaw.config import AgentConfig, WebhookConfig
from geniriclaw.webhook.manager import WebhookManager
from geniriclaw.webhook.models import WebhookEntry, WebhookResult, render_template
from geniriclaw.webhook.observer import _SAFETY_END, _SAFETY_START, WebhookObserver
...
def _make_manager(paths: GeniriclawPaths) -> WebhookManager:
