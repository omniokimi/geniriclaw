...
- Python file changes in geniriclaw/ (hot-reload via watchfiles)
...
WATCH_DIR = PROJECT_ROOT / "geniriclaw"
...
async def supervisor() -> None:
    ...
    os.environ["GENIRICLAW_SUPERVISOR"] = "1"
    fast_crash_count = 0
    cmd = [sys.executable, "-m", "geniriclaw"]
