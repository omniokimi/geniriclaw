...
from geniriclaw.cli.factory import create_cli
...
from geniriclaw.cli.types import AgentRequest, AgentResponse, CLIResponse

if TYPE_CHECKING:
    from geniriclaw.cli.base import BaseCLI
