...
Environment variables GENIRICLAW_AGENT_NAME and GENIRICLAW_INTERAGENT_PORT are
automatically set by the Geniriclaw framework.
"""
...
def main() -> None:
    ...
    chat_id = os.environ.get("GENIRICLAW_CHAT_ID", "")
    topic_id = os.environ.get("GENIRICLAW_TOPIC_ID", "")
    if chat_id:
