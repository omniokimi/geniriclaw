...
from geniriclaw.cli.types import AgentRequest, CLIResponse
...
async def test_execute_returns_agent_response() -> None:
    ...
    with patch("geniriclaw.cli.service.create_cli") as mock_create:
        mock_cli = AsyncMock()
...
async def test_execute_streaming_success() -> None:
    ...
    from geniriclaw.cli.stream_events import AssistantTextDelta, ResultEvent
