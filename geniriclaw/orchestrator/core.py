...
from geniriclaw.background import (
    BackgroundSubmit,
    BackgroundTask,
)
from geniriclaw.cli.process_registry import ProcessRegistry
from geniriclaw.cli.service import CLIService, CLIServiceConfig
from geniriclaw.config import AgentConfig
from geniriclaw.cron.manager import CronManager
...
from geniriclaw.infra.inflight import InflightTracker
from geniriclaw.orchestrator.commands import (
    cmd_cron,
    cmd_diagnose,
    cmd_memory,
    cmd_model,
...
from geniriclaw.orchestrator.directives import parse_directives
from geniriclaw.orchestrator.flows import (
    StreamingCallbacks,
    heartbeat_flow,
    named_session_flow,
...
from geniriclaw.orchestrator.hooks import (
    DELEGATION_BRIEF,
    DELEGATION_REMINDER,
    MAINMEMORY_REMINDER,
    MessageHookRegistry,
)
from geniriclaw.orchestrator.observers import ObserverManager
from geniriclaw.orchestrator.providers import ProviderManager
from geniriclaw.orchestrator.registry import CommandRegistry, OrchestratorResult
from geniriclaw.security import detect_suspicious_patterns
from geniriclaw.session import SessionKey, SessionManager
from geniriclaw.session.manager import SessionData
from geniriclaw.session.named import NamedSessionRegistry
from geniriclaw.webhook.manager import WebhookManager
from geniriclaw.workspace.paths import GeniriclawPaths

if TYPE_CHECKING:
    from geniriclaw.background import BackgroundObserver
    from geniriclaw.bus.bus import MessageBus
    from geniriclaw.config import ModelRegistry
    from geniriclaw.multiagent.bus import AsyncInterAgentResult
    from geniriclaw.multiagent.supervisor import AgentSupervisor
    from geniriclaw.session.named import NamedSession
    from geniriclaw.tasks.hub import TaskHub
...
class Orchestrator:
    ...
    def __init__(
        ...
        *,
        ...
        self._config = config
        self._paths: GeniriclawPaths = paths
    ...
    @property
    def paths(self) -> GeniriclawPaths:
    ...
    async def create(
        ...
        *,
        ...
        """
        from geniriclaw.orchestrator.lifecycle import create_orchestrator
    ...
    def register_multiagent_commands(self) -> None:
        ...
        """
        from geniriclaw.multiagent.commands import (
            cmd_agent_restart,
            cmd_agent_start,
            cmd_agent_stop,
            cmd_agents,
    ...
    def submit_named_session(
        ...
        from geniriclaw.cli.param_resolver import resolve_cli_config
    ...
    async def _ensure_docker(self) -> None:
        ...
        from geniriclaw.orchestrator.lifecycle import ensure_docker
    ...
    async def handle_interagent_message(
        ...
        *,
        ...
        from geniriclaw.orchestrator.injection import (
    ...
    async def inject_prompt(
        ...
        *,
        ...
        from geniriclaw.orchestrator.injection import _inject_prompt
    ...
    async def shutdown(self) -> None:
        ...
        from geniriclaw.orchestrator.lifecycle import shutdown
