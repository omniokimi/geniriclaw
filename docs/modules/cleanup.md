...
- `~/.geniriclaw/workspace/telegram_files/` (Telegram media)
- `~/.geniriclaw/workspace/matrix_files/` (Matrix media)
- `~/.geniriclaw/workspace/output_to_user/`
- `~/.geniriclaw/workspace/api_files/`
