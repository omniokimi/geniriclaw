...
- macOS/Windows: file tail from `~/.geniriclaw/logs/agent.log` (fallback newest `*.log`)
...
Centralised loading of user-defined API secrets from `~/.geniriclaw/.env`.
