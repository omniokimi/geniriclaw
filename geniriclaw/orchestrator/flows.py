...
from geniriclaw.cli.timeout_controller import TimeoutConfig as TCConfig
from geniriclaw.cli.timeout_controller import TimeoutController
from geniriclaw.cli.types import AgentRequest, AgentResponse
from geniriclaw.config import NULLISH_TEXT_VALUES, resolve_timeout
from geniriclaw.i18n import t
from geniriclaw.infra.inflight import InflightTurn
from geniriclaw.log_context import set_log_context
from geniriclaw.orchestrator.hooks import HookContext
from geniriclaw.orchestrator.registry import OrchestratorResult
from geniriclaw.session import SessionData, SessionKey
from geniriclaw.text.response_format import session_error_text, timeout_error_text
...
async def _gemini_missing_config_key_warning(
    ...
    """Warn when Gemini API-key mode is selected but Geniriclaw config key is empty."""
...
async def normal(
    ...
    *,
    ...
    if warning is not None:
        logger.warning("Gemini API-key mode without configured geniriclaw key")
        return warning
