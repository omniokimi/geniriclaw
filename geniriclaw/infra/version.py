...
_PYPI_URL = "https://pypi.org/pypi/geniriclaw/json"
_GITHUB_RELEASES_URL = "https://api.github.com/repos/igorfabrus/geniriclaw/releases"
_PACKAGE_NAME = "geniriclaw"
_TIMEOUT = aiohttp.ClientTimeout(total=10)


def get_current_version() -> str:
    """Return the installed version of geniriclaw."""
    try:
