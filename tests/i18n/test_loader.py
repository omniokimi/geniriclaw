...
from geniriclaw.i18n import LANGUAGES, get_language, get_store, init, t, t_cmd, t_plural, t_rich
from geniriclaw.i18n.loader import TranslationStore, _flatten, _load_toml
...
def test_all_language_dirs_exist() -> None:
    i18n_dir = Path(__file__).resolve().parent.parent.parent / "geniriclaw" / "i18n"
