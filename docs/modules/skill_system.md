...
Cross-tool skill sync between geniriclaw workspace and CLI skill homes.
...
- main: `~/.geniriclaw`
- sub-agent: `~/.geniriclaw/agents/<name>`

## Bundled skills

Bundled source: `geniriclaw/_home_defaults/workspace/skills/`.
...
2. union names
3. pick canonical source by priority (`geniriclaw > claude > codex > gemini`)
...
`cleanup_geniriclaw_links(paths)` removes managed links under CLI skill dirs whose targets point to managed roots.
