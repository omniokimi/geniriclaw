...
from geniriclaw.messenger.telegram.buttons import extract_buttons
from geniriclaw.messenger.telegram.formatting import (
    TELEGRAM_MSG_LIMIT,
...
if TYPE_CHECKING:
    ...
    from geniriclaw.config import StreamingConfig
...
class StreamEditor:
    ...
    async def append_system(self, text: str) -> None:
        ...
        indicator = f"<blockquote>{html.escape(text)}</blockquote>"
        await self._send(indicator)
...
def create_stream_editor(
    ...
    *,
    ...
    from geniriclaw.messenger.telegram.edit_streaming import EditStreamEditor
