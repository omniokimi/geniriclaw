"""Service management CLI subcommands (``geniriclaw service ...``)."""
...
def print_service_help() -> None:
    ...
    table.add_column()
    table.add_row("geniriclaw service install", "Install and start background service")
    table.add_row("geniriclaw service status", "Show service status")
    table.add_row("geniriclaw service start", "Start the service")
    table.add_row("geniriclaw service stop", "Stop the service")
    table.add_row("geniriclaw service logs", "View live logs")
    table.add_row("geniriclaw service uninstall", "Remove the service")
    _console.print(
...
def cmd_service(args: list[str]) -> None:
    """Handle 'geniriclaw service <subcommand>'."""
    from geniriclaw.infra.service import (
        install_service,
        print_service_logs,
