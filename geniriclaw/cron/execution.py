...
from geniriclaw.cli.codex_events import parse_codex_jsonl
from geniriclaw.cli.gemini_events import parse_gemini_json
...
def enrich_instruction(instruction: str, task_folder: str) -> str:
    ...
    return (
        ...
        "- The final answer is delivered to Telegram automatically by geniriclaw.\n"
