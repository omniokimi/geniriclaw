...
from geniriclaw.infra.updater import perform_upgrade_pipeline, write_upgrade_sentinel
    ...
    *,
    ...
    async with bot._upgrade_lock:
        ...
        await asyncio.to_thread(
            ...
            bot._orch.paths.geniriclaw_home,
            chat_id=chat_id,
...
async def handle_changelog_callback(
    ...
    *,
    ...
    from geniriclaw.infra.version import _parse_version, fetch_changelog
