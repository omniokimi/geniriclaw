...
This is the top-level `~/.geniriclaw` directory.
...
- `~/.geniriclaw/agents.json` is the single source of truth for all sub-agent
...
`~/.geniriclaw/SHAREDMEMORY.md` contains facts shared across all agents
