...
class TestDedupeCache:
    ...
    def test_first_check_returns_false(self) -> None:
        from geniriclaw.messenger.telegram.dedup import DedupeCache
    ...
    def test_expired_entry_returns_false(self) -> None:
        ...
        with patch("geniriclaw.messenger.telegram.dedup.time") as mock_time:
...
class TestBuildDedupKey:
    ...
    def test_key_format(self) -> None:
        from geniriclaw.messenger.telegram.dedup import build_dedup_key
