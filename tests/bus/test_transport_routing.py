...
from geniriclaw.bus.envelope import DeliveryMode, Envelope, Origin
...
class TestCascadingFallback:
    ...
    async def test_fallback_logs_warning(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        env = _env(transport="mx", delivery=DeliveryMode.UNICAST)
        with caplog.at_level("WARNING", logger="geniriclaw.bus.bus"):
            await bus.submit(env)
    ...
    async def test_fallback_delivery_failure_is_logged(
        ...
        env = _env(transport="mx", delivery=DeliveryMode.UNICAST)
        with caplog.at_level("ERROR", logger="geniriclaw.bus.bus"):
            await bus.submit(env)
...
class TestAdapterTransportParam:
    def test_from_cron_result_includes_transport(self) -> None:
        ...
        from geniriclaw.bus.adapters import from_cron_result
    ...
    def test_from_heartbeat_includes_transport(self) -> None:
        ...
        from geniriclaw.bus.adapters import from_heartbeat
...
class TestCronJobTransport:
    def test_cron_job_has_transport_field(self) -> None:
        ...
        from geniriclaw.cron.manager import CronJob
...
# -- Executor GENIRICLAW_TRANSPORT env var --


class TestExecutorTransportEnv:
    def test_build_subprocess_env_includes_transport(self) -> None:
        """_build_subprocess_env sets GENIRICLAW_TRANSPORT from CLIConfig."""
        from geniriclaw.cli.base import CLIConfig
        from geniriclaw.cli.executor import _build_subprocess_env
        ...
        assert env["GENIRICLAW_TRANSPORT"] == "mx"

    def test_build_subprocess_env_default_transport(self) -> None:
        """_build_subprocess_env defaults GENIRICLAW_TRANSPORT to 'tg'."""
        from geniriclaw.cli.base import CLIConfig
        from geniriclaw.cli.executor import _build_subprocess_env
        ...
        env = _build_subprocess_env(config)
        assert env is not None
        assert env["GENIRICLAW_TRANSPORT"] == "tg"
