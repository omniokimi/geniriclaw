...
class TestAuthMiddleware:
    ...
    async def test_allowed_user_passes(self) -> None:
        from geniriclaw.messenger.telegram.middleware import AuthMiddleware
...
class TestSequentialMiddleware:
    ...
    async def test_sequential_processing(self) -> None:
        from geniriclaw.messenger.telegram.middleware import SequentialMiddleware
...
class TestIsQuickCommand:
    ...
    def test_is_quick_command(self, text: str, expected: bool) -> None:
        from geniriclaw.messenger.telegram.middleware import is_quick_command
...
class TestQueueManagement:
    ...
    async def test_cancel_entry_marks_cancelled(self) -> None:
        from geniriclaw.messenger.telegram.middleware import SequentialMiddleware, _QueueEntry
