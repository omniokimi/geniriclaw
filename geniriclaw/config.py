...
class DockerConfig(BaseModel):
    ...
    enabled: bool = False
    image_name: str = "geniriclaw-sandbox"
    container_name: str = "geniriclaw-sandbox"
...
class MatrixConfig(BaseModel):
    ...
    user_id: str = ""  # @geniriclaw:myserver.com
    ...
    store_path: str = "matrix_store"  # relative to geniriclaw_home
...
class AgentConfig(BaseModel):
    ...
    provider: str = "claude"
    model: str = "opus"
    geniriclaw_home: str = "~/.geniriclaw"
