...
This directory is part of geniriclaw's three-way skill sync.
...
- Priority when duplicates exist: `geniriclaw > claude > codex`.
- Real directories are never overwritten.
- Broken geniriclaw-managed links are cleaned automatically.
