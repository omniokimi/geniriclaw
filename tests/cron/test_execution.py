...
class TestBuildCmd:
    ...
    def test_returns_none_when_cli_missing(self) -> None:
        ...
        with patch("geniriclaw.cron.execution.which", return_value=None):
    ...
    def test_gemini_provider(self) -> None:
        ...
        with patch("geniriclaw.cron.execution.find_gemini_cli", return_value="/usr/bin/gemini"):
            result = build_cmd(exec_config, "hello")
        assert result is not None
    ...
    def test_gemini_returns_none_when_cli_missing(self) -> None:
        ...
        with patch(
            "geniriclaw.cron.execution.find_gemini_cli",
