...
from geniriclaw.infra.restart import consume_restart_sentinel
from geniriclaw.infra.updater import UpdateObserver, consume_upgrade_sentinel
...
async def _handle_restart_sentinel(bot: TelegramBot) -> dict[str, object] | None:
    ...
    sentinel_path = bot._orch.paths.geniriclaw_home / "restart-sentinel.json"
...
async def _handle_recovery(bot: TelegramBot, sentinel: dict[str, object] | None) -> None:
    ...
    upgrade = await asyncio.to_thread(consume_upgrade_sentinel, bot._orch.paths.geniriclaw_home)
    if upgrade:
    ...
    from geniriclaw.infra.startup_state import detect_startup_kind, save_startup_state
    from geniriclaw.text.response_format import startup_notification_text
    ...
    from geniriclaw.infra.recovery import RecoveryPlanner
    from geniriclaw.text.response_format import recovery_notification_text
...
async def _run_primary_startup(bot: TelegramBot) -> None:
    ...
    from geniriclaw.messenger.telegram.chat_tracker import ChatTracker
