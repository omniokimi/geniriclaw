...
from geniriclaw.messenger.telegram.abort import (
    is_abort_all_message,
    is_abort_message,
    is_interrupt_message,
)
from geniriclaw.messenger.telegram.dedup import DedupeCache, build_dedup_key
    ...
    async def _send_indicator(self, chat_id: int, entry: _QueueEntry, event: Message) -> None:
        ...
        try:
            sent = await self._bot.send_message(
                chat_id,
                "<blockquote>Сообщение в очереди…</blockquote>",
