...
from geniriclaw.bus.cron_sanitize import sanitize_cron_result_text
from geniriclaw.bus.envelope import Envelope, Origin
...
class TelegramTransport:
    ...
    async def _deliver_background(self, env: Envelope) -> None:
        ...
        if env.session_name:
            ...
            from geniriclaw.messenger.telegram.buttons import extract_buttons_for_session
