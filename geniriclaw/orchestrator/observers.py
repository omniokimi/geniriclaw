...
from geniriclaw.background import BackgroundObserver, BackgroundResult

if TYPE_CHECKING:
    from geniriclaw.bus.bus import MessageBus
from geniriclaw.cleanup import CleanupObserver
from geniriclaw.cli.codex_cache import CodexModelCache
from geniriclaw.cli.codex_cache_observer import CodexCacheObserver
from geniriclaw.cli.gemini_cache_observer import GeminiCacheObserver
from geniriclaw.cli.service import CLIService
from geniriclaw.config import AgentConfig, get_gemini_models
from geniriclaw.config_reload import ConfigReloader
from geniriclaw.cron.manager import CronManager
from geniriclaw.cron.observer import CronObserver
from geniriclaw.heartbeat import HeartbeatObserver
from geniriclaw.webhook.manager import WebhookManager
from geniriclaw.webhook.models import WebhookResult
from geniriclaw.webhook.observer import WebhookObserver
from geniriclaw.workspace.init import watch_rule_files
from geniriclaw.workspace.paths import GeniriclawPaths
from geniriclaw.workspace.skill_sync import watch_skill_sync
...
class ObserverManager:
    ...
    def __init__(self, config: AgentConfig, paths: GeniriclawPaths) -> None:
        self._config = config
        self._paths = paths
    ...
    def wire_to_bus(
        ...
        *,
        ...
        """
        from geniriclaw.bus.adapters import (
