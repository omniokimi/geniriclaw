...
def test_create_cli_returns_gemini() -> None:
    with (
        patch("geniriclaw.cli.gemini_provider.find_gemini_cli", return_value="/usr/bin/gemini"),
        patch("geniriclaw.cli.gemini_provider.find_gemini_cli_js", return_value=None),
    ):
